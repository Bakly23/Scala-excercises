...
trait Solver extends GameDef {
  ...
  def neighborsWithHistory(b: Block, history: List[Move]): Stream[(Block, List[Move])] =
    Stream((b.left, Left :: history), (b.up, Up :: history), (b.right, Right :: history), (b.down, Down :: history))
      .filter(tuple => terrain(tuple._1.b1) && terrain(tuple._1.b2))
  ...
  def newNeighborsOnly(neighbors: Stream[(Block, List[Move])],
                       explored: Set[Block]): Stream[(Block, List[Move])] = neighbors.filter(tuple => !explored(tuple._1))
